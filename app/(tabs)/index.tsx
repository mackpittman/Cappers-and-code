  ...
  return (
    ...
    >
      <Card accent="green">
        ...
        <Body small muted>
          Est is the model's probability from goal-line share, end-zone targets, implied team totals
          and the opposing defense. Edge is est minus the price's implied probability. Green means
          the number is worth playing. Units, not dollars.
        </Body>
      </Card>
